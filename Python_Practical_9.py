## Archana Vyas
## 20CE157
## Git Repository: https://github.com/Archna1304/Python_Practical-9.git
...
if __name__ == '__main__':
    student = Student(1, 'Archana')
    student.display()
    print()

    exam = Exam(2, 'Maharshi', [10, 20, 30])
    exam.display()
    print()

    result = Result(3, 'Chirag', [40, 50, 60])
    result.display()
    print()